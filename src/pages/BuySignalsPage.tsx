...
export function BuySignalsPage({ onBack }: BuySignalsPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      {/* Header */}
      <header className="border-b border-gray-800 bg-gradient-to-r from-green-900/[0.65] to-gray-900 sticky top-0 z-50">
                ...
                {bidAnalysis && (
                  <div className="bg-gray-800/50 rounded-lg p-4">
                    <p className="text-sm text-gray-300">
                      ...
                      <span className="block sm:inline text-gray-500 sm:ml-2">(${bidAnalysis.distance.toFixed(2)} away)</span>
                    </p>
